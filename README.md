# Blazorise Bug Report Template for Tailwind
...
(Not using `Tailwind` or need more flexibility? Check out additional templates [here](https://github.com/Blazorise/BugReportTemplate).)